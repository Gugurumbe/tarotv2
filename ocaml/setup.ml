...
(* OASIS_START *)
(* DO NOT EDIT (digest: 119aef17ca5b37dc69a724b44c9f2de5) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Interface"; "Client_config"; "Liste_invitations"];
                      lib_pack = false;
                      lib_internal_modules = ["Stubs"; "Client_proto"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/ascii_renderer";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "libtarotv_ascii"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\248\208o`\248\184V\162\197DK@\200\161\247\156";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
