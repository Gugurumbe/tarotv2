...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6c558731f403619bf719d4952d943374) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Value"; "Lwt_unix_server"];
                      lib_pack = false;
                      lib_internal_modules = ["Lwt_value"];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\192\201\133\211[}\151\002\169\175\139\220\134\b\\}";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
