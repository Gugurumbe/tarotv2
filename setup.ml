...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5bf2b1247d06587d56d8f57feb730a45) *)
(*
...
let setup_t =
  {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("ocamlbuild",
                           ["src/client_qt/client_qt.cxxnative"])))
                 ]
            };
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "client_qt.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.4");
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "&T\141\243\255\021U%\029\na\147\161_V\n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
